...
class Settings:
    ...
    wanfang_app_key: str = os.getenv("WANFANG_APP_KEY", "")
    wanfang_app_secret: str = os.getenv("WANFANG_APP_SECRET", "")
    wanfang_api_version: str = os.getenv("WANFANG_API_VERSION", "1.0")
    wanfang_query_type: str = os.getenv("WANFANG_QUERY_TYPE", "NEW")
